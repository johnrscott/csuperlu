...
fn main() {
    ...
    let p = Complex::<f32>::new(16.0, 0.0);
    let e = Complex::<f32>::new(5.0, 0.0);
    let r = Complex::<f32>::new(18.0, 0.0);
    let l = Complex::<f32>::new(12.0, 0.0);
    ...
    // Make the RHS vector
    let nrhs = 1;
    let rhs = vec![Complex::<f32>::new(1.0, 0.0); num_rows];
